...
PIXELS          = 16
DELAY           = 0#.0167        # .0167 is about 60fps
...
def VURGB(vulib, pixelStep, colorSpeed, subColorSpeed, decay, reset):
    ...
    while EXIT_SIG:
        ...
        volume     = MapValue(CPeaks[0], 0, maxVU, 0, 999)
            
        pixelStep = checkStep(pixelStep)
        pixelColors, _ = guage(volume, pixelStep, subColorSpeed, 0, 1000)
